...
# Set - изменяемый, неиндексируемый, неупорядоченный, итерируемый - тип данных который хранит в себе уникальные значение. Множество хранит в себе только неизменяемый тип данных 
